  ...
  return (
    <main className="flex flex-col h-screen">
      ...
      <div
        ...
        className="w-screen min-h-1 grow bg-tertiary"
      ></div>
      {editMode && (
        <div
          id="editting-tools"
          className="flex flex-row bottom-0 bg-primary h-[9rem] p-3"
        >
          ...
          <div className="flex flex-row items-baseline w-fit gap-3">
            <img
              src="/svg/pencil.png"
              alt=""
              className="h-[8rem] transition ease-in-out hover:translate-y-[-.5rem] hover:cursor-pointer"
            />
            <img
              src="/svg/eraser.png"
              alt=""
              className="h-[4rem] transition ease-in-out hover:translate-y-[-.5rem] hover:cursor-pointer"
            />
          </div>
          <div className="w-[3rem]">{chevronLeftSVG(colors.tertiary)}</div>
        </div>
      )}
    </main>
  );
